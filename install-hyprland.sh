...
sudo pacman -S --noconfirm less fastfetch gnome-keyring breeze breeze5 breeze-gtk papirus-icon-theme nwg-look btop yad dotnet-sdk nodejs npm docker docker-compose tree qalculate-gtk zsh whois playerctl lxappearance kvantum grim slurp steam libreoffice-fresh gimp xdg-desktop-portal-hyprland xdg-desktop-portal-wlr
...
sudo cp ./config/hypr/hyprland.conf "$HOME/.config/hypr/"
sudo cp ./config/kitty/current-theme.conf "$HOME/.config/kitty/"
sudo cp ./config/kitty/kitty.conf "$HOME/.config/kitty/"
